...
const Body: React.FC = () => {
    return <div className="  justify-end items-start " >
        ...
        <h1 className="text-blue-400 font-extrabold justify-end items-start " style={{alignItems: "start", textAlign: "start", fontSize:25, marginTop: 20, color: "#4339ae", backgroundColor: "ghostwhite"}}> How to mint SolToon?</h1>

        <div className=" text-blue-400 hover:text-blue-500 transition space-x-2 flex items-center">
